...
void main() {
  ...
  test('a fresh database is created directly at version 5', () async {
  ...
  test('migrates a valid v1 database and backfills normalized names', () async {
    ...
    // Schema version is now 5 (v1→v2 category migration, v2→v3 security
    // tables, v3→v4 paired_count, v4→v5 related_file_candidates) and the
